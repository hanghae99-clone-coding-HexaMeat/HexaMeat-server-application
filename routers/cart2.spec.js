...
const token =
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6Indhbm9zczU1YWEiLCJpYXQiOjE2MjY2OTQyODd9.fapIR0f8NUK_hARUEtwNq0kRKxo2o_iyyDIjTny8nW4';

test('장바구니 수정을 하면 수정한 수량을 내보냄', async () => {
    let response = await supertest(app)
        .patch(encodeURI('/cart?cartId=60f56813386ff94276c12911&action=plus'))
